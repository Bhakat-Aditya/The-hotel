    ...
    <div ref={pageRef}>
      ...
      <section className="amenity-hero">
        ...
        <div className="amenity-hero-content">
          ...
          <p className="label-text" style={{ marginBottom: '1rem', marginTop: '1rem' }}>{subtitle}</p>
          <div className="gold-line" style={{ marginBottom: '1.5rem' }} />
          <h1 className="heading-xl" style={{ marginBottom: '1rem' }}>{title}</h1>
          <p className="body-text" style={{ maxWidth: '600px', fontSize: '1rem' }}>{description}</p>
        </div>
      </section>
      ...
      {features && features.length > 0 && (
        <section className="section-padding">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <p className="label-text section-reveal" style={{ marginBottom: '1rem' }}>What Awaits You</p>
            <div className="gold-line-center section-reveal" style={{ marginBottom: '2rem' }} />
            <h2 className="heading-lg section-reveal">
              Our <span style={{ color: 'var(--color-gold)', fontStyle: 'italic' }}>Offerings</span>
            </h2>
          </div>
      ...
      {details && details.length > 0 && (
        <section className="section-padding info-section" style={{ background: 'var(--color-dark-light)' }}>
          <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              <p className="label-text" style={{ marginBottom: '1rem' }}>Essential Details</p>
              <div className="gold-line-center" style={{ marginBottom: '2rem' }} />
              <h2 className="heading-md">
                Everything You Need to <span style={{ color: 'var(--color-gold)', fontStyle: 'italic' }}>Know</span>
              </h2>
            </div>
      ...
      {galleryImages && galleryImages.length > 0 && (
        <section className="section-padding amenity-gallery">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <p className="label-text" style={{ marginBottom: '1rem' }}>Gallery</p>
            <div className="gold-line-center" style={{ marginBottom: '2rem' }} />
            <h2 className="heading-md">
              Visual <span style={{ color: 'var(--color-gold)', fontStyle: 'italic' }}>Moments</span>
            </h2>
          </div>
          <div
            style={{
          ...
          >
            {galleryImages.map((img, i) => (
              <div
                key={i}
                className="gallery-item img-hover-zoom"
                style={{
      ...
      >
        ...
        <h2 className="heading-md" style={{ marginBottom: '1rem' }}>
          Ready to <span style={{ color: 'var(--color-gold)', fontStyle: 'italic' }}>Experience</span> This?
        </h2>
